...
PROFILES: dict[str, BetSlipConfig] = {
    ...
    "medium_risk": BetSlipConfig(
        ...
        consensus_vs_sources=0.60,  # favor consensus/quality slightly more
        min_source_edge=0.03,  # weed out low-edge noise
