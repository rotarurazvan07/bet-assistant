...
from dashboard.constants import COLORS, RADIUS_LG, STYLE_HEADER_GRADIENT
                                ...
                                [
                                    dbc.CardHeader(
                                        html.Small(
                                            [
                                                html.I(
                                                    className="fas fa-eye me-2 text-primary"
                                                ),
                                    ...
                                    dbc.CardBody(
                                        dcc.Loading(
                                            id="builder-preview-loading",
                                            type="circle",
                                            color="var(--bs-primary)",
                                            children=html.Div(
                                                id="builder-output-container"
                                            ),
                                        ),
                                        className="pt-0 px-3 pb-3",
                                    ),
                                    ...
                                    [
                                        dbc.CardHeader(
                                            html.Small(
                                                [
                                                    html.I(
                                                        className="fas fa-ban me-2 text-danger"
                                                    ),
                                                    "Excluded Matches",
                                                ],
                                                className="fw-bold text-uppercase text-muted",
                                        ...
                                        dbc.CardBody(
                                            html.Div(id="excluded-matches-list"),
                            ...
                            html.Div(
                                [
                                    ...
                                    dbc.Button(
                                        ...
                                        id="btn-generate-slips",
                                        color="success",
                                        size="sm",
                                        className="ms-2 shadow-sm",
                                    ),
                                    dbc.Switch(
                                        id="hide-settled-slips",
                                        label="Hide Settled",
                                        value=False,
                                ...
                                [
                                    dbc.CardHeader(
                                        html.Small(
                                            [
                                                html.I(
                                                    className="fas fa-clock me-2 text-primary"
                                                ),
                                                "Scheduled Tasks",
                                            ],
                                            className="fw-bold text-uppercase text-muted",
                                ...
                                [
                                    dbc.CardHeader(
                                        html.Small(
                                            [
                                                html.I(
                                                    className="fas fa-heartbeat me-2 text-success"
                                                ),
                                                "Service Status",
                                            ],
                                            className="fw-bold text-uppercase text-muted",
...
def analytics_tab_layout() -> html.Div:
    return html.Div(
        [
            ...
            html.H4(
                [
                    html.I(className="fas fa-history me-2 text-primary"),
                    "History Tracking",
                ],
            ...
            html.H4(
                [
                    html.I(className="fas fa-project-diagram me-2 text-warning"),
    ...
    return dbc.Container(
        [
            ...
            dbc.Row(
                                                ...
                                                html.Div(
                                                    [
                                                        ...
                                                        dbc.Button(
                                                            [
                                                                html.I(
                                                                    className="fas fa-cloud-download-alt me-2"
                                                                ),
                                                                "Pull Update",
                                                            ],
                                                            id="btn-pull-update",
                ...
                className="mb-4 mx-0",
            ),  # mx-0 prevents horizontal scroll on some browsers
            # ── Global Filters ───────────────────────────────────────────────────
            dbc.Card(
                [
                    dbc.CardBody(
